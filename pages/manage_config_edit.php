...
$f_gpc = array(
	...
	'mail_monitor_make_public'		=> gpc_get_int( 'mail_monitor_make_public' ),
	'mail_monitor_exclude_addresses'=> array_map( 'strtolower', array_filter( array_map( 'trim', explode( "\n", str_replace( array( "\r\n", "\r" ), "\n", gpc_get_string( 'mail_monitor_exclude_addresses' ) ) ) ) ) ),
	...
	'mail_strip_quoted_lines'		=> gpc_get_int( 'mail_strip_quoted_lines' ),
	'mail_strip_quoted_lines_min_lines'=> gpc_get_int( 'mail_strip_quoted_lines_min_lines' ),
